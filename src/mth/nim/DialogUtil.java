...
/**
 * @author Almas Baimagam   betov (almaslvl@gmail.com)
 */
...
//            dialog.openDialog();
     ...
     static class CustomDialog extends Stage {
        ...
        CustomDialog(Parent content) {
            ...
            setScene(new Scene(content, null));
        }
